...
class WC_Gateway_DOE_Cheque extends WC_Payment_Gateway {
    public $instructions;
    ...
    public function __construct() {
        $this->id = 'doe_cheque';
        $this->icon = apply_filters('wc_doe_cheque_icon', '');
        $this->has_fields = false;
        $this->method_title = __('Crypto Payment (doe_cheque)', 'dynamic-order-emails');
        $this->method_description = __('Allow customers to pay via Cryptocurrency at checkout.', 'dynamic-order-emails');
    ...
    public function init_form_fields() {
		...
		$this->form_fields = array(
			'enabled' => array(
				...
				'type' => 'checkbox',
				'label' => __('Enable Crypto Payment', 'dynamic-order-emails'),
				'default' => 'yes'
			),
			'title' => array(
				...
				'default' => __('Crypto Payment', 'dynamic-order-emails'),
				'desc_tip' => true,
			),
			'description' => array(
				...
				'default' => __('Pay with Cryptocurrency upon order completion.', 'dynamic-order-emails'),
				'desc_tip' => true,
			),
			'instructions' => array(
			...
			'email_section_title' => array(
				'title' => __('Automation Email Settings (Global)', 'dynamic-order-emails'),
				'type' => 'title',
				'description' => __('Configure crypto payment automation emails for all customers worldwide', 'dynamic-order-emails'),
			),
			'doe_check_initial_reminder_time' => array(
			...
			'doe_check_initial_subject' => array(
				'title' => __('Initial Email Subject', 'dynamic-order-emails'),
				'type' => 'text',
				'default' => 'PAYMENT LINK : [{company_name}]: New order #{order_id}',
				'description' => __('Subject line for the initial payment reminder email', 'dynamic-order-emails'),
				'desc_tip' => true,
			),
			'doe_check_reminder_24_time' => array(
			...
			'doe_check_reminder_24_subject' => array(
				'title' => __('24h Reminder Email Subject', 'dynamic-order-emails'),
				'type' => 'text',
				'default' => 'REMINDER : [{company_name}]: New order #{order_id}',
				'description' => __('Subject line for the 24-hour reminder email', 'dynamic-order-emails'),
				'desc_tip' => true,
			),
			'doe_check_reminder_48_time' => array(
			...
			'doe_check_reminder_48_subject' => array(
				'title' => __('48h Reminder Email Subject', 'dynamic-order-emails'),
				'type' => 'text',
				'default' => 'KINDLY REMINDER : [{company_name}]: New order #{order_id}',
				'description' => __('Subject line for the 48-hour reminder email', 'dynamic-order-emails'),
				'desc_tip' => true,
			),
			'doe_check_email' => array(
				'title' => __('Crypto Email Content (Global)', 'dynamic-order-emails'),
				'type' => 'wpeditor',
				...
				'description' => __('This email content will be used for ALL customers regardless of their country. Use <strong>for bold</strong>, <em>for italic</em>, <u>for underline</u>, and <br> for line breaks. Use {customer_name}, {order_id}, {company_name}, {currency}, {order_total}, and {from_email} for dynamic content.', 'dynamic-order-emails'),
				'desc_tip' => false,
			),
			...
			'enable_for_methods' => array(
				...
				'css' => 'width: 400px;',
				'default' => '',
				'description' => __('If Crypto Payment is only available for certain methods, set it up here. Leave blank to enable for all methods.', 'dynamic-order-emails'),
			...
			'enable_for_virtual' => array(
				...
				'label' => __('Accept Crypto Payment if the order is virtual', 'dynamic-order-emails'),
				'type' => 'checkbox',
				'default' => 'yes'
			)
		);
    ...
    public function process_payment($order_id) {
        ...
        if (!$this->is_available_for_shipping($order)) {
            wc_add_notice(__('Crypto Payment is not available for the selected shipping method.', 'dynamic-order-emails'), 'error');
            return;
        }
        $order->update_status('on-hold', __('Awaiting Crypto payment', 'dynamic-order-emails'));
